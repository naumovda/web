...
namespace ConsoleApp2.Models
{
    ...
    {
        public List<Standart> Standarts { get; set; } = null!;
        public List<AirMass> AirMasses { get; set; } = null!;
        public List<Illuminant> Illuminants{ get; set; } = null!;
        public List<Observer> Observers { get; set; } = null!;
        public List<CalculationState> CalculationStates { get; set; } = null!;
        public List<MakeupType> MakeupTypes { get; set; } = null!;
        public List<WarningType> WarningTypes { get; set; } = null!;

        public List<Project> Projects { get; set; } = null!;
        public List<Makeup> Makeups { get; set; } = null!;
        public List<Parameter> Parameters { get; set; } = null!;
        public List<Layer> Layers { get; set; } = null!;
        public List<Coating> Coatings { get; set; } = null!;
        public List<Substrate> Substrates { get; set; } = null!;
        public List<Gas> Gas { get; set; } = null!;

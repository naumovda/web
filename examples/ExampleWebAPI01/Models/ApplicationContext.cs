...
{
    public class ApplicationContext2415 : DbContext
    {
        public DbSet<Standart> Standarts { get; set; }
        public DbSet<AirMass> AirMasses { get; set; } = null!;
        public DbSet<Illuminant> Illuminants{ get; set; } = null!;
        public DbSet<Observer> Observers { get; set; } = null!;
        public DbSet<CalculationState> CalculationStates { get; set; } = null!;
        public DbSet<MakeupType> MakeupTypes { get; set; } = null!;
        public DbSet<WarningType> WarningTypes { get; set; } = null!;
        public DbSet<Project> Projects { get; set; } = null!;
        public DbSet<Makeup> Makeups { get; set; } = null!;
        public DbSet<Parameter> Parameters { get; set; } = null!;
        public DbSet<Layer> Layers { get; set; } = null!;
        public DbSet<Coating> Coatings { get; set; } = null!;
        public DbSet<Substrate> Substrates { get; set; } = null!;
        public DbSet<Gas> Gas { get; set; } = null!;

        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            optionsBuilder.UseSqlServer("Data Source=.\\SQLEXPRESS;Initial Catalog=Web2415-02;Integrated Security=True;Connect Timeout=30;Encrypt=False;Trust Server Certificate=True");
        }
        

        public ApplicationContext2415(DbContextOptions<ApplicationContext2415> options)
        : base(options)
        {
